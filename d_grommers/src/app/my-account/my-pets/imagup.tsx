            ...
            {preview ? (
                <div className="relative group w-32 h-32">
                    ...
                    <div className="absolute inset-0 bg-black bg-opacity-50 rounded opacity-0 group-hover:opacity-100 flex justify-center items-center transition-opacity">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" onClick={handleImageRemove} style={{ color: "white" }} className="size-12 text-white-500 hover:cursor-pointer" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
